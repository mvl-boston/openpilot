...
#define HONDA_COMMON_NO_SCM_FEEDBACK_RX_CHECKS(pt_bus)                                                                                \
  {.msg = {{0x1A6, (pt_bus), 8, .max_counter = 3U, .ignore_quality_flag = true, .frequency = 25U}, /* SCM_BUTTONS */                  \
           {0x296, (pt_bus), 4, .max_counter = 3U, .ignore_quality_flag = true, .frequency = 25U},                                    \
           {0}}},                                                                                                                     \
...
#define HONDA_COMMON_RX_CHECKS(pt_bus) \
  HONDA_COMMON_NO_SCM_FEEDBACK_RX_CHECKS(pt_bus){.msg = {{0x326, (pt_bus), 8, .max_counter = 3U, .ignore_quality_flag = true, .frequency = 10U}, {0}, {0}}}, /* SCM_FEEDBACK */
...
static safety_config honda_nidec_init(uint16_t param)
{
  ...
  static CanMsg HONDA_N_TX_MSGS[] = {{0xE4, 0, 5, .check_relay = true}, {0x194, 0, 4, .check_relay = true}, {0x1FA, 0, 8, .check_relay = false}, {0x30C, 0, 8, .check_relay = true}, {0x33D, 0, 5, .check_relay = true}};
  ...
  if (enable_nidec_alt)
  {
    ...
    static RxCheck honda_nidec_alt_rx_checks[] = {
        HONDA_COMMON_NO_SCM_FEEDBACK_RX_CHECKS(0){.msg = {{0x1FA, 2, 8, .max_counter = 3U, .ignore_quality_flag = true, .frequency = 50U}, {0}, {0}}}, // BRAKE_COMMAND
    };
  ...
  else
  {
    ...
    static RxCheck honda_nidec_common_rx_checks[] = {
        HONDA_COMMON_RX_CHECKS(0){.msg = {{0x1FA, 2, 8, .max_counter = 3U, .ignore_quality_flag = true, .frequency = 50U}, {0}, {0}}}, // BRAKE_COMMAND
    };
...
static safety_config honda_bosch_init(uint16_t param)
{
  ...
  static CanMsg HONDA_BOSCH_TX_MSGS[] = {{0xE4, 0, 5, .check_relay = true}, {0xE5, 0, 8, .check_relay = true},
                                         ...
                                         {0x33DB, 0, 8, .check_relay = true}}; // Bosch
  ...
  static CanMsg HONDA_RADARLESS_LONG_TX_MSGS[] = {{0xE4, 0, 5, .check_relay = true}, {0x33D, 0, 8, .check_relay = true}, {0x1C8, 0, 8, .check_relay = true}, {0x30C, 0, 8, .check_relay = true}}; // Bosch radarless w/ gas and brakes
