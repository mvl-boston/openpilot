...
from opendbc.car.honda.values import CruiseButtons, VISUAL_HUD, HONDA_BOSCH, HONDA_BOSCH_RADARLESS, BOSCH_ALT_BRAKE_PCM_ACCEL, HONDA_NIDEC_ALT_PCM_ACCEL, CarControllerParams
    ...
    if not self.CP.openpilotLongitudinalControl:
      ...
      if self.frame % 2 == 0:
        ...
        if self.CP.carFingerprint in HONDA_BOSCH:
          ...
          if self.CP.carFingerprint in BOSCH_ALT_BRAKE_PCM_ACCEL:
            self.gas = float(np.interp(accel, self.params.BOSCH_GAS_IMPERIAL_LOOKUP_BP, self.params.BOSCH_GAS_IMPERIAL_LOOKUP_V))
          else:
