...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"HondaUnwindFreeze", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"HondaUnwindLookahead", {PERSISTENT | BACKUP, BOOL, "1"}},
    ...
    {"HondaNotchEnabled", {PERSISTENT | BACKUP, BOOL, "1"}},
    ...
    {"HondaSteerDeltaLimiter", {PERSISTENT | BACKUP, BOOL, "1"}},
    ...
    {"HondaCivicRadarTryout", {PERSISTENT | BACKUP, BOOL, "1"}},
