...
INPUT_INVALID_LIMIT = 5.0 # was 2.0 # 1 (camodo) / 9 (sensor) bad input[s] ignored
INPUT_INVALID_RECOVERY = 1.0 # was 10.0 # ~10 secs to resume after exceeding allowed bad inputs by one
