...
def create_acc_commands(packer, CAN, enabled, active, accel, gas, stopping_counter, car_fingerprint):
  commands = []
  min_gas_accel = -0.01 if CS.out.vEgo < 4 / 2.23694 else -0.3 # allow wind brake above 4 mph, otherwise brake at neg accel below idle speed of 4mph --- temp set to -0.2 since software crashed
